...
import { addAreaCurso, updateAreaCurso } from "services/cursosService";
...
class AddAreaCurso extends React.Component {
  state = {
    id: "",
    nome: "",
    descricao: ""
  ...
  render() {
    const header = this.props.location.state && this.props.location.state.id ? 'Alterar área do curso' : 'Adicionar área do curso'
    return (
      <>
        <Header />
        {/* Page content */}
...
export default connect(mapStateToProps)(AddAreaCurso);
